...
var paths = {
  js: ['*.js', 'test/**/*.js', '!test/coverage/**', '!bower_components/**',
        'packages/**/*.js',
        '!packages/**/node_modules/**', '!packages/contrib/**/*.js', '!packages/contrib/**/node_modules/**', '!packages/custom/**'],
...
module.exports = function(grunt) {
  ...
  grunt.registerTask('heroku:dev', ['cssmin', 'uglify']);
};
